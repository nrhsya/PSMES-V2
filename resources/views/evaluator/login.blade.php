        ...
        <div class="row d-flex">
            ...
            <div class="col-lg-6">
                <div class="card2 card border-0 px-4 py-5">
                    ...
                    <form method="post" action="{{ route('evaluator.check') }}">
                    @if (Session::get('fail'))
                    ...
                    @endif
                        ...
                        <div class="row m-3">
                            ...
                            <button type="submit"  class="customButton">Login</button><br>
                    ...
                    <div class="row mb-4 px-3 text-center">
                        <strong>
                            <small class="font-weight-bold">Don't have an account?
                                <a href="{{ route('evaluator.register') }}" class="text-danger ">Register</a>
                            </small>
                        </strong>
                    </div>
                </div>
